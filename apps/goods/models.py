...
class GoodsSKU(BaseModel):
    ...
    unite = models.IntegerField(default=1, verbose_name='商品单位')
...
class IndexGoodsBanner(BaseModel):
    ...
    class Meta:
        ...
        verbose_name = '首页轮播商品展示'
        verbose_name_plural = verbose_name


class IndexTypeGoodsBanner(BaseModel):
    '''首页分类商品展示'''
    DISPALY_TYPE_CHOICES = ((0, '标题'), (1, '图片'))
    ...
    display_type = models.SmallIntegerField(default=1, choices=DISPALY_TYPE_CHOICES, verbose_name='展示方式')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
